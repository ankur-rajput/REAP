								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="col-md-5 dropdown">
											<span> <form:select path="badge" class="form-control" required
												name="badgeType" id="badgeType">
													<option>Select a Badge</option>
													<option value="gold">Gold   (${remainingBadges.gold})</option>
													<option value="silver">Silver   (${remainingBadges.silver})</option>
													<option value="bronze">Bronze   (${remainingBadges.bronze})</option>
											</form:select>
											</span>
										</div>
										<div class="col-md-7">
											<span> <form:select path="karma" class="form-control" required
												name="karma" id="karma">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<form:textarea path="reason" class="form-control" rows="7" resize="none"></form:textarea>
									</div>
								</div>
							</div>
							<div class="row">
						...
						<div class="row">
							...
							<div class="col-lg-8" style="padding-top: 10px">
								...
								<div class="row" style="padding-top: 5px">
									<div class="col-xs-3">
										Z <img class="img-rounded img-responsive"
